          ...
          {isLoading ? (
            ...
            <>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                <button style={{ background: 'transparent', color: 'var(--accent)', fontSize: '0.85rem', fontWeight: 600 }}>Optimize</button>
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
              <button 
                ...
                style={{ background: 'transparent', color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '1rem', textAlign: 'left' }}
              >
                ← Back to List
              </button>
              ...
              <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {taskStatus === 'assigned' && (
                  <button className="btn-primary" onClick={handleStartWork} style={{ justifyContent: 'center', padding: '1rem' }}>
                    <Clock size={18} /> Mark In Progress
                  </button>
                )}
                
                {taskStatus === 'in_progress' && (
                  <button className="btn-secondary" onClick={handleUploadPhoto} style={{ justifyContent: 'center', padding: '1rem', borderColor: 'var(--accent)', color: 'var(--accent)' }}>
                ...
                {taskStatus === 'photo_uploaded' && (
                  <>
                    ...
                    <button className="btn-primary" onClick={handleResolve} style={{ justifyContent: 'center', padding: '1rem' }}>
